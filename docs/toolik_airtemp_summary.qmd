...
```{r}
# needs to be cleaned, clean names
...
```{r}
# turn the periods into nas; store the function first
...
# active chloro var is stored as characters, need to store as numbers
...
ggplot(data = toolik_chlorophyll,
  ...
  labs(title = "Toolik Chlorophyll Concentration",
       x = "Lake depth (meters)",
       y = "Active chlorophyll concentration (mcg/L)")
```
